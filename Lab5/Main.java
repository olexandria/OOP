                        ...
                        while (!exit) {
                            ...
                            switch (command) {
                                ...
                                case 2:
                                    ...
                                    string = scan.nextLine();
                                    if(string.matches("\\d+")){
                                        temp.setNumber(string);
                                        System.out.println("Успішно змінено!");
                                        break;
                                    }
                                    else
                                        System.err.println("Не змінено! Введіть номер з цифр!");
                                    break;
                                case 3:
                                    System.out.println("Введіть нову дату народження:");
                                    scan.nextLine();
                                    String  inn = scan.nextLine();
                                    if (!RegEx.isValidDateOfBirth(inn)) {
                                        System.err.println("Неправильний формат!");
                                        break;
                                    }
                                    temp.setDateOfBitrh(inn);
                                    System.out.println("Успішно змінено!");
                                    break;
                                case 4:
                                    System.out.println("Введіть нову дату редагування:");
                                    scan.nextLine();
                                    String  innn = scan.nextLine();
                                    if (!RegEx.isValidDateOfEditing(innn)) {
                                        System.err.println("Неправильний формат!");
                                        break;
                                    }
                                    temp.setDateOfEditing(innn);
                                    System.out.println("Успішно змінено!");
                                    break;
                                case 5:
                                    exit = true;
